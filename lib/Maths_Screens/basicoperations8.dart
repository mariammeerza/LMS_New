...
class BasicOperations8 extends StatefulWidget {
  const BasicOperations8({super.key});

  @override
  State<BasicOperations8> createState() => _BasicOperations8State();
}

class _BasicOperations8State extends State<BasicOperations8> {
              ...
              child: TextButton(
                onPressed:isOptionSelected ? () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const BasicOperations9(),
                    ),
                  );
                }:null,
