...
class BasicOperations10 extends StatefulWidget {
  ...
  @override
  State<BasicOperations10> createState() => _BasicOperations10State();
}

class _BasicOperations10State extends State<BasicOperations10> {
                      ...
                      child: RichText(
                        text: const TextSpan(
                          children: [
                            ...
                            TextSpan(
                              text:
                                  'Map shows the distance between towns in miles.What is the shortest distance Anita must travel to get from Malayapur to Charni?',
                              style: TextStyle(
                                fontFamily: 'OnboardFont1',
                                fontSize: 16.0,
                                color: Color(0xFF494949),
